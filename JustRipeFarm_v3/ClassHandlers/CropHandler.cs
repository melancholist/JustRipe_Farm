...
namespace JustRipeFarm_v3
{
    class CropHandler
    {
        ...
        {
            string insertQuery = "INSERT INTO crop (type, seedCompany, seedLotNumber, seedOrigin, organic, gmo, plantSpacing, plantingDepth, seedPerHole, plantingMethod, additionalInformation)"
                + "VALUES ('" + crop.Type + "', '" + crop.SeedCompany + "'  , " + crop.SeedLotNumber + ", '" +
